...
export const CartProvider = ({ children }) => {
  ...
  const addToCart = (product) => {
    ...
    if (eachProduct) {
      ...
      updatedCart = state.products.map((obj) =>
        obj.id === eachProduct.id
          ? { ...eachProduct, quantity, totalAmount }
          : obj
      );
    } else {
      ...
      updatedCart = [
        ...state.products,
        { ...product, quantity: 1, totalAmount },
      ];
    }
  ...
  //             const eachPro = state.products.filter((e) => e.id === product.id )[0];

  //             return { eachPro, quantity, totalAmount }
  //             // if(obj.quantity >=0){
  //             //     const totalAmount = obj?.amount * quantity;
  //             //     return { ...obj, quantity, totalAmount }
  //             // }else{
  //             //     return obj
  //             // }
  //         } else {
